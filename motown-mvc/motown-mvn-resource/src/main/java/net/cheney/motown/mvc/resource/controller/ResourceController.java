package net.cheney.motown.mvc.resource.controller;
...
import static net.cheney.motown.mvc.resource.api.Elements.activeLock;
import static net.cheney.motown.mvc.resource.api.Elements.href;
import static net.cheney.motown.mvc.resource.api.Elements.lockDiscovery;
import static net.cheney.motown.mvc.resource.api.Elements.multistatus;
import static net.cheney.motown.mvc.resource.api.Elements.prop;
import static net.cheney.motown.mvc.resource.api.Elements.propertyStatus;
import static net.cheney.motown.mvc.resource.api.Elements.response;
import static net.cheney.motown.mvc.resource.api.Lock.Scope.EXCLUSIVE;
import static net.cheney.motown.mvc.resource.api.Lock.Type.WRITE;
...
import net.cheney.motown.mvc.resource.api.Elements;
import net.cheney.motown.mvc.resource.api.Lock;
import net.cheney.motown.mvc.resource.api.Property;
import net.cheney.motown.mvc.resource.api.Resource;
import net.cheney.motown.mvc.resource.api.ResourceProvidor;
import net.cheney.motown.mvc.resource.api.Elements.ACTIVE_LOCK;
import net.cheney.motown.mvc.resource.api.Elements.MULTISTATUS;
import net.cheney.motown.mvc.resource.api.Elements.PROPSTAT;
import net.cheney.motown.mvc.resource.api.Elements.RESPONSE;
import net.cheney.motown.mvc.resource.api.Resource.ComplianceClass;
import net.cheney.motown.mvn.dispatcher.COPY;
import net.cheney.motown.mvn.dispatcher.DELETE;
import net.cheney.motown.mvn.dispatcher.Destination;
import net.cheney.motown.mvn.dispatcher.Fragment;
import net.cheney.motown.mvn.dispatcher.GET;
import net.cheney.motown.mvn.dispatcher.LOCK;
import net.cheney.motown.mvn.dispatcher.MKCOL;
import net.cheney.motown.mvn.dispatcher.MOVE;
import net.cheney.motown.mvn.dispatcher.OPTIONS;
import net.cheney.motown.mvn.dispatcher.Overwrite;
import net.cheney.motown.mvn.dispatcher.PROPFIND;
import net.cheney.motown.mvn.dispatcher.PROPPATCH;
import net.cheney.motown.mvn.dispatcher.PUT;
import net.cheney.motown.mvn.dispatcher.PathTranslated;
import net.cheney.motown.mvn.dispatcher.UNLOCK;
