...
public enum MimeType {
	...
	public enum MediaType {
		...
		public static MimeType.MediaType parse(String mediaType) {
	...
	private MimeType(MimeType.MediaType mediaType, String subType, String... extensions) {
	...
	public boolean isCompatible(MimeType c) {
